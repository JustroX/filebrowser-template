...
echo "FILEBROWSER_USERNAME_PATH: $FILEBROWSER_USERNAME_PATH"
rm -f $DATABASE_PATH
...
#     /filebrowser users add $WEB_USERNAME $WEB_PASSWORD --perm.admin --perm.execute --database $DATABASE_PATH > /dev/null
# fi
